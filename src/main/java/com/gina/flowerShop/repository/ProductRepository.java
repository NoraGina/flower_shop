...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("select p from Product p  INNER JOIN p.categories c where c.idCategory=:idCategory and p.origin=:origin and p.stock=:stock")
    List<Product> findAllByCategoryIdOriginAndStockGreaterThan(@Param("idCategory")Long idCategory,@Param("origin")String origin, @Param("stock")int stock);
    ...
    long countByProductNameAndImage(@Param("productName")String productName, @Param("image") byte[] image);
}
